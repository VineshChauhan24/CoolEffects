...
public class FireworksMain extends Canvas implements Runnable {          

	private static final long serialVersionUID = 1L;
	public final static int WIDTH = 1024;
	public final static int HEIGHT = 700;
	private final static int MAX_FIREWORKS = 8;
	private static boolean running = false;
	private Thread main_thread;
	private Firework ffww[];
	
	public FireworksMain() {
		ffww = new Firework[MAX_FIREWORKS];
	...
	public static void main(String[] args) {
		FireworksMain my_app = new FireworksMain();
